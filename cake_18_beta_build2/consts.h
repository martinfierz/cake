...
// OR returnvalue of delta of eval with SUPERPRUNECONST to start superpruning; 
// to get original delta, use delta(delta);
#define SUPERPRUNECONST 1024
#define getdelta(x) (x&1023);