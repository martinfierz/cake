...
#define VERSION "1.8 beta QS + LMR"

#undef SUPERPRUNE
#define SUPERPRUNELEVEL 20
//#define FIXEDDEPTH 3
#undef THREADSAFEHT					// locks access to dblookup, hashlookup and hashstore if set.
#undef THREADSAFEDB

#undef RAZORING
#define RAZORWINDOW 100
...
#define ALWAYSSTORE					// overwrite hashentries even if the new one has less depth? 
									// if yes, define this
#define OVERWRITEDEPTH 4*FRAC		// is only used if alwaysstore is off!
