...
#undef WIN64
//#define WIN32
//#define VERSION "Manchester 1.09d"
#define VERSION "2.0 beta build 20"
//#define FIXEDDEPTH 3


#include "consts.h"

#undef SOLVE // if this is defined, cake will attempt to prove a position a draw.
...
#define LAZYEVALWINDOW 500			// if materialeval is more than this outside of alpha-beta window, 
