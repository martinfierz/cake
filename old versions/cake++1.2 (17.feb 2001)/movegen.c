...
/* here a static evaluation for the moves should be !*/
  ...
  /* now do the ordering */
         ...
         /* and set as sentinel */
         tmpmove=movelist[0];
         movelist[0]=movelist[best];
         movelist[best]=tmpmove;
#endif
#ifdef SORTALL
         /* now do the rest of the sort */
         for(i=1;i<n;i++)
         	{
            j=i;
            tmpmove=movelist[i];
...
static void blackorderevaluation(struct move ml[MAXMOVES],int n)
	{
   int eval;
   int32 from,to;
   int32 black,i;
...
static void whiteorderevaluation(struct move ml[MAXMOVES],int n)
	{
   int eval;
   int32 from,to;
   int32 white,i;
         ...
         swap=1;
      	while(swap)
         	...
         	swap=0;
      		for(i=0;i<n-1;i++)
      			{
         		if((movelist[i+1].info) > ((movelist[i].info)))
         			{
            		tmpmove=movelist[i];
...
static void blackmancapture1(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
...
static void blackmancapture2(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
...
static void blackkingcapture1(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
...
static void blackkingcapture2(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
   /* partial move has already been executed. seek LFJ1 RFJ1 LBJ1 RBJ1*/
   int32 m,free,white;
   struct move next_partial,whole_partial;
...
static void whitemancapture1(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
...
static void whitemancapture2(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
   /* partial move has already been executed. seek LBJ1 and RBJ1 */
   int32 m,free,black;
   struct move next_partial,whole_partial;
...
static void whitekingcapture1(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
   /* partial move has already been executed. seek LFJ1 RFJ1 LBJ1 RBJ1*/
   int32 m,free,black;
   struct move next_partial,whole_partial;
...
static void whitekingcapture2(struct move movelist[MAXMOVES],int *n, struct move partial, int32 square)
	{
   /* partial move has already been executed. seek LFJ1 RFJ1 LBJ1 RBJ1*/
   int32 m,free,black;
   struct move next_partial,whole_partial;
