 ...
 *															
 *		Copyright (C) 2000...2010 by Martin Fierz	
 *														
...
// history table array
#ifdef MOHISTORY
int32 history[32][32];				// TODO: make this thread-local, i.e. a member of the SEARCHINFO structure
#endif
...
#ifdef MOHISTORY
	// reset history table					// TODO: this also doesn't look threadsafe!
...
int firstnegamax(SEARCHINFO *si, POSITION *p, MOVE movelist[MAXMOVES], int d, int alpha, int beta, MOVE *best)
	...
	|																			|
	 --------------------------------------------------------------------------*/
	// TODO: remove all static's
	int i,value,swap=0,bestvalue=-MATE;
	/*static*/ int n;					// TODO: why is this static? seems unnecessary
	/*static*/ MOVE ml2[MAXMOVES];		// TODO: why is this static?
	MATERIALCOUNT Lmatcount;
	int Lalpha=alpha;
	int32 forcefirst=0;
	int32 Lkiller=0;
	/*static*/ POSITION last;			// TODO: where is this used? seems nowhere!
	MOVE tmpmove;
	/*static*/ int values[MAXMOVES];	/* holds the values of the respective moves - use to order */  // TODO: seems that this is not needed any more
	int refnodes[MAXMOVES];		//TODO: looks superfluous	/* number of nodes searched to refute a move */
	int statvalues[MAXMOVES];	// TODO: looks superfluous, is not referenced!
